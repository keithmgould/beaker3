...
% denom = (-m__b*m__b*l*l*Cy*Cy+l*l*m__b*m__b+l*l*m__b*m__w+I__b*m__b+I__b*m__w);
% x_dd = -(1/denom)*(-y(4)*y(4)*Sy*l*l*l*m__b*m__b-m__b*m__b*l*l*g*Sy*Cy-I__b*y(4)*y(4)*Sy*l*m__b+y(2)*b*l*l*m__b-l*l*m__b*u+I__b*y(2)*b-I__b*u);
% theta_dd = (1/denom)*((-y(4)*y(4)*Sy*Cy*l*m__b+y(2)*Cy*b-Sy*g*m__b-Sy*g*m__w-Cy*u)*m__b*l);
